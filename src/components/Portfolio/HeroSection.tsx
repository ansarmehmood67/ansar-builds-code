...
const HeroSection = () => {
  ...
  return (
    <section
      className="min-h-screen relative flex items-center justify-start overflow-hidden"
      style={{
        background: `
          radial-gradient(circle at 60% 40%, rgba(16,185,129,0.15), transparent 60%),
          linear-gradient(to bottom right, #000000, #0a1a0f)
        `,
      }}
    >
      {/* Content Container */}
          ...
          <div className="space-y-8">
            ...
            <div className="mb-4">
              <h1 className="text-5xl lg:text-7xl font-black leading-tight">
                <span className="block text-foreground animate-fade-in-up tracking-tight">
                  Ansar Mehmood
                </span>
              </h1>
            </div>
